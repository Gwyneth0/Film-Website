...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  $.widget.bridge('uibutton', $.ui.button)
	...
	$('#submitBtn').click(function(){
		...
		if (isEdit == 'true') {
			alert('true');
			url = '/asmjava4quocdat/admin/video?action=edit&href=' + hrefOrigin;
		} else {
			alert('false');
			url = '/asmjava4quocdat/admin/video?action=add';			
		}
		// nếu thêm newHerf thì edit dc mà add thì hk dc a 
		...
		var formData = {
			...
			$.ajax({
				...
				data: formData
				  ...
				  window.location.href = "http://localhost:8080/asmjava4quocdat/admin/video?action=view";
			}).fail(function(error){
